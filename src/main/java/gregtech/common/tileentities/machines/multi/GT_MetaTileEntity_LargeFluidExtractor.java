...
public class GT_MetaTileEntity_LargeFluidExtractor
    ...
    protected ProcessingLogic createProcessingLogic() {
        return new ProcessingLogic().setEuModifier((float) (getEUMultiplier()))
            .setMaxParallel(getParallels())
            .setSpeedBonus((float) (getSpeedBonus()));
    }
    ...
    public float getEUMultiplier() {
        double heatingBonus = (1 - mCoilLevel.getTier() * HEATING_COIL_EU_DISCOUNT);
